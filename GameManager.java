...
public class GameManager
{
	public static void main(String[] args) {
        ...
        List<String> players = new ArrayList<>(); // To store names of players
	    Players p = new Players(nPlayers); 
	    ...
	    while(true){
    	    ...
    	    for(int i= 0;i<players.size();i++){
    	        ...
    	        else if(curPos<=length*breadth-(2*noOfDice) || curPos ==length*breadth-noOfDice ){
    	            np.put(z,curPos);
